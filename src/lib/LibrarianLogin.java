...
public class LibrarianLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, -50, 1000, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(evt.getSource()==jButton1)
        {
            try
            {
                ...
                String str = "select * from lms_librarian where username='"+username+"' and password ='"+password+"'";
